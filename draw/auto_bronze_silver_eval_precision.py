...
auto_data, bronze_data, silver_data, gold_data = get_precision(exp1_file_path, exp1_sheet_name, auto_column, bronze_column, silver_column)
# auto_data_18454, bronze_data_18454, silver_data_18454, gold_data_18454 = get_precision(mouse_18454_file_path, mouse_18454_sheet_name, auto_column, bronze_column, silver_column)
# auto_data_7, bronze_data_7, silver_data_7, gold_data_7 = get_precision(mouse_7_file_path, mouse_7_sheet_name, auto_column, bronze_column, silver_column)
...
# # 设置横坐标标签倾斜 30 度
# plt.xticks(rotation=30, fontsize=23, ha='right')
