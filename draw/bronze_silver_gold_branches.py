...
def get_branches(file_path, sheet_name, column):
    # 打开 Excel 文件
...
bronze_data = get_branches(bronze_file_path, bronze_sheet_name, branch_column)
silver_data = get_branches(silver_file_path, silver_sheet_name, branch_column)
gold_data = get_branches(gold_file_path, gold_sheet_name, branch_column)
...
plt.ylabel("Number of branches", fontsize=20)
plt.xlabel('')
plt.show()
