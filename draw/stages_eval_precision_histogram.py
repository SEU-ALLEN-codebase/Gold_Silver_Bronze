...
auto_data, bronze_data, silver_data, gold_data, ground_truth_data = get_metric(synthetic_15_file_path, synthetic_15_sheet_name, synthetic_auto_precision_column, synthetic_bronze_precision_column, synthetic_silver_precision_column, synthetic_gold_precision_column, is_human=False)
# auto_recall_data, bronze_recall_data, silver_recall_data, gold_recall_data, ground_truth_recall_data = get_metric(synthetic_15_file_path, synthetic_15_sheet_name, synthetic_auto_recall_column, synthetic_bronze_recall_column, synthetic_silver_recall_column, synthetic_gold_recall_column, True)
